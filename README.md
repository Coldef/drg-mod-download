A Python script to obtain a download link for a mod from mod.io. Since game pass version does not support modding like the Steam version, they have to be installed manually.
